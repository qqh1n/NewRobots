...
public class StandardComponentRussifier {
    private static final String INTERNAL_FRAME_PREFIX = "InternalFrame.";
    private static final String INTERNAL_FRAME_TITLE_PANE_PREFIX = "InternalFrameTitlePane.";
    private static final String OPTION_PANE_PREFIX = "OptionPane.";
